...
import { ManageCommodities } from './ManageCommodities'
...
export function AdminPage({ onNavigateHome, initialSection = 'profile' }: AdminPageProps) {
  ...
  const menuItems = [
    ...
    { id: 'images' as AdminSection, label: 'Images', icon: ImageIcon, category: 'Data Management' },
