...
import { galleryService, GalleryImage as DBGalleryImage } from '@/modules/gallery/services/galleryService'
...
export function GallerySection({
  ...
  const [commodities, setCommodities] = useState<{ label: string; value: number }[]>(gallery.commodities ?? [])
